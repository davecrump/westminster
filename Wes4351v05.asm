...
;                     ttttttt          ttt     tttt                       tt
;
; TX      Synth (= TX Freq/24 * 256) So step is 266.666 kHz
;
...
SENDTR4	NOP			; Send TX Register 4
				; Always 0x00A2803C
	MOVLW	0x00		; so populate BYTE1 - BYTE4
	MOVWF	BYTE1
	MOVLW	0xA2
...
LUTR1B3	ADDWF	PCL, F		; Transmit R1 Byte 3
	RETLW	0x84		; Chan 1
	RETLW	0x80		; Chan 2
	RETLW	0x82		; Chan 3
	RETLW	0x82		; Chan 4
...
LUTR1B4	ADDWF	PCL, F		; Transmit R1 Byte 4
	RETLW	0xB1		; Chan 1
	RETLW	0xC9		; Chan 2
	RETLW	0x59		; Chan 3
	RETLW	0x59		; Chan 4
...
LUTR0B2	ADDWF	PCL, F		; Transmit R0 Byte 2
	RETLW	0x2B		; Chan 1
	RETLW	0x2B		; Chan 2
	RETLW	0x2B		; Chan 3
	RETLW	0x2C		; Chan 4
...
LUTR0B3	ADDWF	PCL, F		; Transmit R0 Byte 3
	RETLW	0x82		; Chan 1
	RETLW	0x80		; Chan 2
	RETLW	0x82		; Chan 3
	RETLW	0x00		; Chan 4
...
LUTR0B4	ADDWF	PCL, F		; Transmit R0 Byte 4
	RETLW	0x98		; Chan 1
	RETLW	0x88		; Chan 2
	RETLW	0x18		; Chan 3
	RETLW	0x40		; Chan 4
